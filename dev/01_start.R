...
golem::fill_desc(
  ...
  repo_url = "https://github.com/thomaszwagerman/poRtfolio" # The URL of the GitHub Repo (optional)
)
...
usethis::use_mit_license("Thomas Zwagerman") # You can set another license here
usethis::use_readme_rmd(open = FALSE)
usethis::use_code_of_conduct("thomas_zwagerman@hotmail.com")
